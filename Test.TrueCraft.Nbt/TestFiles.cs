...
public static class TestFiles {
    ...
    public static void AssertNbtSmallFile(NbtFile file) {
        ...
        Assert.IsAssignableFrom<NbtCompound>(file.RootTag);
    ...
    public static void AssertNbtBigFile(NbtFile file) {
        ...
        Assert.IsAssignableFrom<NbtList>(root["listTest (long)"]);
        ...
        Assert.IsAssignableFrom<NbtByte>(root["byteTest"]);
        node = root["byteTest"];
        ...
        Assert.IsAssignableFrom<NbtByteArray>(root[byteArrayName]);
