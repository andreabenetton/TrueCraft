...
namespace TrueCraft.Nbt
{
    ...
    public class NbtReader
    {
        ...
        {
            if (state == NbtParseState.Error) throw new InvalidReaderStateException(ErroneousStateError);
        ...
        public int Skip()
        {
            ...
            if (state == NbtParseState.AtStreamEnd) return 0;
        ...
        private NbtTag ReadValueAsTag()
        {
            ...
            switch (TagType)
            {
                ...
                case NbtTagType.IntArray:
                    ...
                    for (var i = 0; i < TagLength; i++) ints[i] = reader.ReadInt32();
        ...
        {
            if (state == NbtParseState.AtStreamEnd) throw new EndOfStreamException();
