...
namespace TrueCraft.Nbt.Tags
{
    ...
    /// <remarks>
    ///     Added in Minecraft 1.12. Used by modern world saves for biome storage and
    ///     packed block-state palettes.
    /// </remarks>
    public sealed class NbtLongArray : NbtTag
    {
        private static readonly long[] ZeroArray = new long[0];

        [NotNull] private long[] _longs;
        ...
        internal override void PrettyPrint(StringBuilder sb, string indentString, int indentLevel)
        {
            ...
            sb.AppendFormat(": [{0} longs]", _longs.Length);
        }
    }
}
